...
public class Keys {
    ...
    public static final ForeignKey<AgendaRecord, MemberRecord> FK_AGENDA_MEMBER1 = ForeignKeys0.FK_AGENDA_MEMBER1;
    public static final ForeignKey<AgendaRecord, ProjectRecord> FK_AGENDA_PROJECT1 = ForeignKeys0.FK_AGENDA_PROJECT1;
    public static final ForeignKey<CommentRecord, MemberRecord> FK_COMMENT_MEMBER1 = ForeignKeys0.FK_COMMENT_MEMBER1;
    ...
    public static final ForeignKey<MemberRecord, UserRecord> FK_MEMBER_USER1 = ForeignKeys0.FK_MEMBER_USER1;
    public static final ForeignKey<MemberRecord, ProjectRecord> FK_MEMBER_PROJECT1 = ForeignKeys0.FK_MEMBER_PROJECT1;
    public static final ForeignKey<MessageRecord, MemberRecord> FK_MESSAGE_MEMBER1 = ForeignKeys0.FK_MESSAGE_MEMBER1;
    ...
    public static final ForeignKey<VotingRecord, MemberRecord> FK_VOTING_MEMBER1 = ForeignKeys0.FK_VOTING_MEMBER1;
    public static final ForeignKey<WorkRecord, ProjectRecord> FK_WORK_PROJECT1 = ForeignKeys0.FK_WORK_PROJECT1;
    public static final ForeignKey<WorkRecord, MemberRecord> FK_WORK_MEMBER1 = ForeignKeys0.FK_WORK_MEMBER1;
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<AgendaRecord, MemberRecord> FK_AGENDA_MEMBER1 = Internal.createForeignKey(Keys.KEY_MEMBER_PRIMARY, Agenda.AGENDA, "fk_agenda_member1", new TableField[] { Agenda.AGENDA.MEMBER_ID }, true);
        ...
        public static final ForeignKey<CommentRecord, MemberRecord> FK_COMMENT_MEMBER1 = Internal.createForeignKey(Keys.KEY_MEMBER_PRIMARY, Comment.COMMENT, "fk_comment_member1", new TableField[] { Comment.COMMENT.MEMBER_ID }, true);
        ...
        public static final ForeignKey<MemberRecord, UserRecord> FK_MEMBER_USER1 = Internal.createForeignKey(Keys.KEY_USER_PRIMARY, Member.MEMBER, "fk_member_user1", new TableField[] { Member.MEMBER.USER_ID }, true);
        public static final ForeignKey<MemberRecord, ProjectRecord> FK_MEMBER_PROJECT1 = Internal.createForeignKey(Keys.KEY_PROJECT_PRIMARY, Member.MEMBER, "fk_member_project1", new TableField[] { Member.MEMBER.PROJECT_ID }, true);
        public static final ForeignKey<MessageRecord, MemberRecord> FK_MESSAGE_MEMBER1 = Internal.createForeignKey(Keys.KEY_MEMBER_PRIMARY, Message.MESSAGE, "fk_message_member1", new TableField[] { Message.MESSAGE.MEMBER_ID }, true);
        ...
        public static final ForeignKey<VotingRecord, MemberRecord> FK_VOTING_MEMBER1 = Internal.createForeignKey(Keys.KEY_MEMBER_PRIMARY, Voting.VOTING, "fk_voting_member1", new TableField[] { Voting.VOTING.MEMBER_ID }, true);
        ...
        public static final ForeignKey<WorkRecord, MemberRecord> FK_WORK_MEMBER1 = Internal.createForeignKey(Keys.KEY_MEMBER_PRIMARY, Work.WORK, "fk_work_member1", new TableField[] { Work.WORK.MEMBER_ID }, true);
    }
}

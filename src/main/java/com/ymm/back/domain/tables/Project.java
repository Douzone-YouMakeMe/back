...
public class Project extends TableImpl<ProjectRecord> {
    ...
    private static final long serialVersionUID = -1255597745;
     ...
     */
    public final TableField<ProjectRecord, Integer> USER_ID = createField(DSL.name("user_id"), org.jooq.impl.SQLDataType.INTEGER, this, "");
     ...
     */
    public final TableField<ProjectRecord, String> CONTENTS = createField(DSL.name("contents"), org.jooq.impl.SQLDataType.VARCHAR(2000), this, "");
     ...
     */
    public final TableField<ProjectRecord, String> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>project.url</code>.
     */
    public final TableField<ProjectRecord, String> URL = createField(DSL.name("url"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>project.to</code>.
     */
    public final TableField<ProjectRecord, Integer> TO = createField(DSL.name("to"), org.jooq.impl.SQLDataType.INTEGER, this, "");

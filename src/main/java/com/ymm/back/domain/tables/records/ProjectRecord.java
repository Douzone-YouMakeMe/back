...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record13<Integer, Integer, String, LocalDateTime, String, Integer, String, String, String, Integer, LocalDateTime, LocalDateTime, LocalDateTime> {

    private static final long serialVersionUID = -1104865634;
    ...
    /**
     * Setter for <code>project.finished_at</code>.
     */
    ...
    /**
     * Getter for <code>project.finished_at</code>.
     */
    ...
    @Override
    public Row13<Integer, Integer, String, LocalDateTime, String, Integer, String, String, String, Integer, LocalDateTime, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public ProjectRecord values(Integer value1, Integer value2, String value3, LocalDateTime value4, String value5, Integer value6, String value7, String value8, String value9, Integer value10, LocalDateTime value11, LocalDateTime value12, LocalDateTime value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectRecord(Integer id, Integer userId, String name, LocalDateTime finishedAt, String contents, Integer viewCount, String thumbnail, String description, String authority, Integer total, LocalDateTime createTime, LocalDateTime updateTime, LocalDateTime finishedTime) {
        super(Project.PROJECT);

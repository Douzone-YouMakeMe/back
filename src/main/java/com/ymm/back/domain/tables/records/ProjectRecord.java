...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record15<Integer, Integer, String, String, Integer, String, String, String, Integer, String, String, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime> {

    private static final long serialVersionUID = 2004735354;
    ...
    @Override
    public Row15<Integer, Integer, String, String, Integer, String, String, String, Integer, String, String, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime> fieldsRow() {
        return (Row15) super.fieldsRow();
    }

    @Override
    public Row15<Integer, Integer, String, String, Integer, String, String, String, Integer, String, String, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public ProjectRecord values(Integer value1, Integer value2, String value3, String value4, Integer value5, String value6, String value7, String value8, Integer value9, String value10, String value11, LocalDateTime value12, LocalDateTime value13, LocalDateTime value14, LocalDateTime value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectRecord(Integer id, Integer userId, String name, String contents, Integer viewCount, String thumbnail, String description, String authority, Integer total, String type, String url, LocalDateTime startedTime, LocalDateTime createTime, LocalDateTime updateTime, LocalDateTime finishedTime) {
        super(Project.PROJECT);
